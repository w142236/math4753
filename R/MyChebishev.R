#' Chebishev function
#'
#' @description This takes in a number of standard deviations, k, and returns the minimum number of points within that many standard deviations for any distribution
#'
#' @param k
#'
